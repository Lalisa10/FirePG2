...
bool mainTank::checkValidPos(gameMap* Map) const{
       ...
       // check Upper Left point of Tank
       x_in_tile_map = getBox().x / TILE_SIZE;
       y_in_tile_map = getBox().y / TILE_SIZE;
       if(Map->getTileType(x_in_tile_map, y_in_tile_map) == STONE || Map->getTileType(x_in_tile_map, y_in_tile_map) == WATER || Map->getTileType(x_in_tile_map, y_in_tile_map) == GRASS) return false;

       // check Upper Right point of Tank
       x_in_tile_map = (getBox().x + getBox().w - 1) / TILE_SIZE;
       y_in_tile_map = getBox().y / TILE_SIZE;
       if(Map->getTileType(x_in_tile_map, y_in_tile_map) == STONE || Map->getTileType(x_in_tile_map, y_in_tile_map) == WATER || Map->getTileType(x_in_tile_map, y_in_tile_map) == GRASS) return false;

       // check Lower Left point of Tank
       x_in_tile_map = getBox().x / TILE_SIZE;
       y_in_tile_map = (getBox().y + getBox().h - 1) / TILE_SIZE;
       if(Map->getTileType(x_in_tile_map, y_in_tile_map) == STONE || Map->getTileType(x_in_tile_map, y_in_tile_map) == WATER || Map->getTileType(x_in_tile_map, y_in_tile_map) == GRASS) return false;

       // check Lower Right point of Tank
       x_in_tile_map = (getBox().x + getBox().w - 1) / TILE_SIZE;
       y_in_tile_map = (getBox().y + getBox().h - 1) / TILE_SIZE;
       if(Map->getTileType(x_in_tile_map, y_in_tile_map) == STONE || Map->getTileType(x_in_tile_map, y_in_tile_map) == WATER || Map->getTileType(x_in_tile_map, y_in_tile_map) == GRASS) return false;
