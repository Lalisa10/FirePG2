...
const char WINDOW_TITLE[] = "FirePG";
...
const int MAIN_BULLET_VELOCITY = 10;
const int ENEMY_BULLET_VELOCITY = 17;
const int BULLET_SIZE = 15;
const int ROCKET_VELOCITY = 5;
...
const int ENEMY_ATTACK_SPEED = 500;
const int ENEMY_NUMBER = 4;
const int MAX_ENEMY_NUMBER = 6;
